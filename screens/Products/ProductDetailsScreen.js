        ...
        <View styles = {styles.container}>
            ...
            <View style={styles.ProductsDetailsScreen}>
                ...
                <View style = {{justifyContent : "center", alignItems : "center"}}>
                    <Image source={require('../../assets/images/tomato.png')} style={{ height: 213, width: 280, borderRadius : 20 }} />
                </View>
                ...
                <View style =  {{flexDirection : 'row', marginLeft : 18, marginRight : 16, marginTop: 24}}>
                    <View>
                        ...
                        <Text style = {{fontSize : 16, marginTop : 23, color : '#555655'}}>200 g</Text>
                    </View>
                ...
                <View style = {{marginLeft : 18, marginRight : 16, marginTop : 17}}>
                    ...
                    <Text style = {{fontSize : 16, marginTop: 8, fontFamily: 'Archivo-Medium', color : '#555655'}}>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum corporis necessitatibus, ipsa nam modi illum numquam</Text>
                </View>
